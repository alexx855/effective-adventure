...
import { IBeeProps, trimAddress, Hexagon, coordFromString } from '../utils';
...
const Bee = forwardRef<any, IBeeProps>((props, ref) => {
    ...
    const image = isDead
        ? './assets/4x/Bee_left@4x.png'
        : './assets/4x/Bee_dead@4x.png';
...
const PixiPlayer = forwardRef<any, IBeeProps>((props, ref) => {
