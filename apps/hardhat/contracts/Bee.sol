...
contract Bee is ERC721Enumerable, Ownable {
    ...
    function freeMint() public {
        ...
        require(id < MAX_NFTS, 'MAX_SUPPLY_REACHED');
        require(block.timestamp < mintDeadline, 'DONE MINTING');

        uint256 itemId = mintItem();
        _safeMint(msg.sender, itemId);
    }

    function mintItem() public returns (uint256) {
        // TODO: add locking mechanism, same for freeMint
        require(block.timestamp < mintDeadline, 'DONE MINTING');
        _tokenIds.increment();
    ...
    function renderTokenById(uint256 id) public view returns (string memory) {
        ...
        string
            memory svgPartOne = '<path class="st0" d="M53.2 49.9 62 60.8l-13.3-4.3 4.5-6.6z"/>';
        string
            memory svgPartTwo = '<path class="st1" d="m51.5 30.7-.2 2.6 1.9-1.8-.6 2.5 2.1-1.6-.8 2.5 2.2-1.4-1.1 2.4 2.4-1L56 37l2.5-.7-1.7 1.9 2.6-.3-2 1.7 2.6.1-2.2 1.4 2.6.5-2.4 1 2.5.8-2.5.8 2.4 1.1-2.6.5 2.2 1.4-2.6.2 2.1 1.6h-2.7l1.9 1.9-2.7-.4 1.6 2.1-2.6-.7 1.4 2.2-2.4-.9 1.2 2.3-2.4-1.1.9 2.4-2.3-1.4.7 2.5-2.1-1.6.5 2.6-2-1.7.3 2.6L47 58v2.6l-1.7-2-.2 2.6-1.5-2.2-.4 2.6-1.2-2.2-.6 2.5-1.1-2.4-.8 2.5-1-2.4-1 2.4-.8-2.5-1.1 2.4-.6-2.6-1.3 2.3-.4-2.6-1.5 2.2-.2-2.6-1.7 2V58l-1.8 1.9.3-2.6-2 1.7.5-2.6-2.1 1.6.7-2.5-2.3 1.4.9-2.4-2.4 1.1 1.2-2.3-2.5.9 1.4-2.2-2.6.7 32.3-22z"/>';
